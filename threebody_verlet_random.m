...
%% Random Case: 
% The 3 body Problem with origin-directed initial velocities and the bodies
% arranged in a scalene triangle. A simple but decent demo of why the three
% body problem is... a problem.
